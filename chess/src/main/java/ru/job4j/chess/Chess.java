...
public class Chess extends Application {
    ...
    private Rectangle buildFigure(int x, int y, int size, String image) {
        ...
        rect.setOnMouseReleased(
                event -> {
                    ...
                    try {
                        isMoved = board.move(this.findBy(momento.getX(), momento.getY()), this.findBy(event.getX(), event.getY()));
    ...
    private void buildBlackTeam(Group grid) {
        this.add(new PawnBlack(Cell.A7, false), grid);
        this.add(new PawnBlack(Cell.B7, false), grid);
        this.add(new PawnBlack(Cell.C7, false), grid);
        this.add(new PawnBlack(Cell.D7, false), grid);
        this.add(new PawnBlack(Cell.E7, false), grid);
        this.add(new PawnBlack(Cell.F7, false), grid);
        this.add(new PawnBlack(Cell.G7, false), grid);
        this.add(new PawnBlack(Cell.H7, false), grid);
        this.add(new RookBlack(Cell.A8, false), grid);
        this.add(new KnightBlack(Cell.B8), grid);
        this.add(new BishopBlack(Cell.C8), grid);
        this.add(new QeenBlack(Cell.E8), grid);
        this.add(new KingBlack(Cell.D8, false), grid);
        this.add(new BishopBlack(Cell.F8), grid);
        this.add(new KnightBlack(Cell.G8), grid);
        this.add(new RookBlack(Cell.H8, false), grid);
    }
    ...
    public void buildWhiteTeam(Group grid) {
        ...
        this.add(new QeenWhite(Cell.E1), grid);
